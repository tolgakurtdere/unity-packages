...
namespace TK.Localization
{
    internal static class TashkeelFixer
    {
        ...
        /// </summary>
        public static void RemoveTashkeel(RtlStringBuilder input)
        {
        ...
        /// </summary>
        public static void RestoreTashkeel(RtlStringBuilder letters)
        {
        ...
        /// </summary>
        public static void FixShaddaCombinations(RtlStringBuilder input)
        {
            /*
