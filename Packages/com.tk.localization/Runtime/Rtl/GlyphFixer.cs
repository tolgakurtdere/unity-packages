...
namespace TK.Localization
{
    internal static class GlyphFixer
    {
        ...
        /// <returns></returns>
        public static void Fix(RtlStringBuilder input, RtlStringBuilder output, bool preserveNumbers, bool farsi, bool fixTextTags)
        {
            FixYah(input, farsi);
            ...
            for (int i = 0; i < input.Length; i++)
            {
                ...
                if (iChar < 0xFFFF && RtlTextUtils.IsGlyphFixedArabicCharacter((char)iChar))
                {
        ...
        public static void FixYah(RtlStringBuilder text, bool farsi)
        {
        ...
        private static bool HandleSpecialLam(RtlStringBuilder input, RtlStringBuilder output, int i)
        {
            bool isFixed;
        ...
        public static void FixNumbers(RtlStringBuilder text, bool farsi)
        {
        ...
        public static void FixNumbersOutsideOfTags(RtlStringBuilder text, bool farsi)
        {
        ...
        private static bool IsLeadingLetter(RtlStringBuilder letters, int index)
        {
            ...
            bool isPreviousLetterNonConnectable = index == 0 ||
                                                  (previousIndexLetter < 0xFFFF && !RtlTextUtils.IsGlyphFixedArabicCharacter((char)previousIndexLetter)) ||
            ...
            bool isNextLetterConnectable = index < letters.Length - 1 &&
                                           (nextIndexLetter < 0xFFFF && RtlTextUtils.IsGlyphFixedArabicCharacter((char)nextIndexLetter)) &&
        ...
        private static bool IsFinishingLetter(RtlStringBuilder letters, int index)
        {
        ...
        private static bool IsMiddleLetter(RtlStringBuilder letters, int index)
        {
            var currentIndexLetter = letters.Get(index);
