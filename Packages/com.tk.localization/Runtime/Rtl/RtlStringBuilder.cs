...
namespace TK.Localization {
    internal class RtlStringBuilder {
        ...
        public RtlStringBuilder(int capacity) {
            if (capacity < 0)
        ...
        public RtlStringBuilder(string text) : this(text, text.Length) {
        }

        public RtlStringBuilder(string text, int capacity) : this(capacity) {
            SetValue(text);
        }

        public static implicit operator string(RtlStringBuilder x) {
            return x.ToString();
        }

        public static implicit operator RtlStringBuilder(string x) {
            return new RtlStringBuilder(x);
        }
        ...
        public void SetValue(RtlStringBuilder other) {
        ...
        public void Insert(int pos, RtlStringBuilder str, int offset, int count) {
        ...
        public void Insert(int pos, RtlStringBuilder str) {
        ...
        public void Substring(RtlStringBuilder output, int start, int length) {
            output.length = 0;
        ...
        public void Replace(RtlStringBuilder oldStr, RtlStringBuilder newStr)
        {
            for (int i = 0; i < length; i++)
            {
                bool match = true;
