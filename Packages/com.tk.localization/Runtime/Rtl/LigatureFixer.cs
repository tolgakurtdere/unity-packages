...
namespace TK.Localization
{
    internal static class LigatureFixer
    {
        ...
        private static void FlushBufferToOutput(List<int> buffer, RtlStringBuilder output)
        {
        ...
        /// </summary>
        public static void Fix(RtlStringBuilder input, RtlStringBuilder output, bool farsi, bool fixTextTags, bool preserveNumbers)
        {
