...
| --- | --- | --- | --- | --- |
| `com.tk.core` | 0.1.1 | 6000.0+ | Reusable core systems: save system, UI framework (layouts, popups, navigation stack, busy overlay), app flow with level progression, and utilities. Modules are usable à la carte via separate asmdefs. | [README](Packages/com.tk.core/README.md) |
